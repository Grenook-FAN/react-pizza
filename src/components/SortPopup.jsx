...
const SortPopup = React.memo(function SortPopup({ items, activeSortType, onSelectSortPopup }){
    ...
    const handleOutsideClick = (elem) => {
        if (!elem.path.includes(sortRef.current)) {
